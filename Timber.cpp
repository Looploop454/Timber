...
int main()
{
	...
	spriteCloud2.setPosition(700, 0);
	spriteCloud3.setPosition(1400, 0);
	...
	double timeBarStartWidth = 400;
	double timeBarHeight = 80;
	...
	//This was some test code I wrote to test the updateBranch function and make sure that it
	//was working
	/*updateBranches(1);
	updateBranches(2);
	updateBranches(3);
